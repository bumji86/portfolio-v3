...
type SharedSeparateFileCodec = Extract<ReturnType<ReturnType<typeof defineCodec>>, {
    decode: unknown;
}>;
...
export type ExtractorMessage = ReturnType<SharedSeparateFileCodec['decode']>[number];
/**
